                ...
                >
                  <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-10 w-full">
                    <div className="max-w-2xl mx-auto sm:mx-0 sm:ml-8 text-center sm:text-left">
                      ...
                      <button className="bg-orange-500 hover:bg-orange-600 text-white text-base sm:text-lg lg:text-xl px-6 sm:px-8 lg:px-10 py-3 sm:py-4 lg:py-5 rounded-lg w-full sm:w-auto font-semibold">
                        Get Started Now
                      </button>
                    </div>
                  </div>
