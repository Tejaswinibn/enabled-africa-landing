    ...
    <>
          ...
          <div className="relative rounded-xl overflow-hidden">
            ...
            <div className="absolute inset-0 flex items-center justify-center px-4 sm:px-6">
              <div className="text-center">
                ...
                {/* Main Text */}
                <h2 className="text-lg sm:text-2xl lg:text-3xl font-bold text-white mb-4 sm:mb-6 lg:mb-8 leading-tight">
                Join as Talent or Employer<br />
                and be part of Africa&apos;s future
                </h2>
                
                {/* CTA Button */}
                <button className="bg-orange-500 hover:bg-orange-600 text-white font-semibold px-6 sm:px-8 lg:px-10 py-3 sm:py-4 lg:py-5 rounded-lg transition-colors shadow-lg text-sm sm:text-base lg:text-lg">
                  Get Started Now
                </button>
              </div>
            </div>
      ...
      <section className="py-6 sm:py-8 lg:py-10 bg-white">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-10 text-center">
          {/* Colorful Slogan */}
          <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-3 sm:mb-4 lg:mb-5 leading-tight">
