...
export function OurValues() {
  return (
    <section className="bg-white py-16 sm:py-20 md:py-24 mt-8 sm:mt-12 lg:mt-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-10">
        {/* Header */}
        <div className="mb-8 sm:mb-12 lg:mb-16 max-w-[52ch] mx-auto text-center">
          <h2 className="text-[24px] sm:text-[28px] font-semibold tracking-tight text-zinc-900">Our Values</h2>
        ...
        {/* Mobile-first grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-y-8 md:gap-y-12 md:gap-x-20">
          ...
          <div className="flex flex-col divide-y divide-zinc-200">
            ...
            <div className="flex items-start gap-3 sm:gap-4 pb-6">
              ...
              <div>
                <h3 className="text-base sm:text-lg font-semibold text-zinc-900">Respect</h3>
            ...
            {/* Trust */}
            <div className="flex items-start gap-3 sm:gap-4 pt-6">
              <ValueBadge>
                <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
              ...
              <div>
                <h3 className="text-base sm:text-lg font-semibold text-zinc-900">Trust</h3>
                <p className="mt-1 text-[15px] leading-7 text-zinc-700">
          ...
          <div className="flex flex-col divide-y divide-zinc-200 md:-mt-8 lg:-mt-12">
            ...
            <div className="flex items-start gap-3 sm:gap-4 pb-6">
              ...
              <div>
                <h3 className="text-base sm:text-lg font-semibold text-zinc-900">Collaboration</h3>
                <p className="mt-1 text-[15px] leading-7 text-zinc-700">
            ...
            {/* Opportunity */}
            <div className="flex items-start gap-3 sm:gap-4 pt-6 pb-6">
              <ValueBadge>
                <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
              ...
              <div>
                <h3 className="text-base sm:text-lg font-semibold text-zinc-900">Opportunity</h3>
                <p className="mt-1 text-[15px] leading-7 text-zinc-700">
            ...
            <div className="flex items-start gap-3 sm:gap-4 pt-6">
              ...
              <div>
                <h3 className="text-base sm:text-lg font-semibold text-zinc-900">Growth</h3>
                <p className="mt-1 text-[15px] leading-7 text-zinc-700">
